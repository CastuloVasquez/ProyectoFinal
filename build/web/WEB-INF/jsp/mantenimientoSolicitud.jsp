            ...
            btnBuscar.addEventListener('click', (e) => {
                ...
                if (codigoSolicitud !== "") {
                    ...
                    if (evaluacionSoli(codigoSolicitud)) {
                        mensaje.innerHTML = "Debe de ingresar codigo de solicitud valido";
                        mensajeM.show();
                    }else{
                        form.submit();
                    }
                } else if (evaluacionExp(noexpediente)) {
                    mensaje.innerHTML = "Debe ingresar No. expediente valido";
                    mensajeM.show();
                } else if (evaluacionSoporte(nosoporte)) {
                    mensaje.innerHTML = "Debe ingresar No. soporte valido";
                    mensajeM.show();
                } else if (evaluacionUsuario(usuarioAsignacion)) {
                    mensaje.innerHTML = "Debe ingresar nombre de usuario valido";
                    mensajeM.show();
                } else if (evaluacionFecha(fechaAntes, fechaFinal)) {
